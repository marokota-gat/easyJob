...
export interface ApiCandidaturaCandidatura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'inviata'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOffertaOfferta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Azienda: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    Luogo: Schema.Attribute.String & Schema.Attribute.Required;
    pubblicazione: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Ruolo: Schema.Attribute.String & Schema.Attribute.Required;
    scadenza: Schema.Attribute.Date;
    TipoContratto: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiProfiloRecruiterProfiloRecruiter
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoAzienda: Schema.Attribute.Media<'images'>;
    nome: Schema.Attribute.String & Schema.Attribute.Required;
    nomeAzienda: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    profiloCandidato: Schema.Attribute.Relation<
      'oneToOne',
      'api::profilo-candidato.profilo-candidato'
    >;
    profiloRecruiter: Schema.Attribute.Relation<
      'oneToOne',
      'api::profilo-recruiter.profilo-recruiter'
    >;
    ...
    userPassword: Schema.Attribute.Password & Schema.Attribute.Required;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::profilo-recruiter.profilo-recruiter': ApiProfiloRecruiterProfiloRecruiter;
